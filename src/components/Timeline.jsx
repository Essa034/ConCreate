...
const days = [
  {
    ...
    events: [
      ...
      { title: 'Level X OR Hive Mind Challenge ', description: 'Level x: The Ultimate Levelling Challenge tests your precision and teamwork in levelling tasks, happening at MACE Campus on 16th January at 10:00 AM.\n\nHive Mind Challenge: Brings creative minds together to brainstorm and pitch bold, eco-friendly ideas. A fast-paced event driven by teamwork, innovation, and sustainable thinking.'},
      { title: 'Bridge Making OR Capture The Flag', description: 'Bridge Making Competition: Where teams race against time at 2 PM on 16th January to design and build a free-standing bridge using only the given materials, blending creativity, strength, and smart engineering.\n\nCapture the Flag competition: Happening on 16th January at 2 PM, featuring logic-based challenges, typing speed, and prompting rounds. Participants should bring a laptop and have basic knowledge of C.' },      { title: 'Civil Expo', description: 'Exhibition showcasing civil engineering projects' },
